...
{
    // TODO:
    float need_flour =  num_pies * 250.0 - flour_remain; // 测一下哈

    if (need_flour > 0) throw need_flour;
...
{
    // TODO:
    int need_egg = num_pies - eggs_remain ;
    if (need_egg > 0) throw need_egg;
}
...
{
    // TODO:
    int need_apple = num_pies * 2 - apples_remain;
    if (need_apple > 0) throw need_apple;
}
...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        catch( MARKET2_CLOSED status2)
        {
            cout << "market2 is closed!" << endl;
            flag = 0;
        }
        catch( int need_apple )
        {
            cout << "Apples in market2 are not enough. You still need " << need_apple << " more." << endl;
            flag = 0;
        }
    }
    catch( MARKET1_CLOSED status1 )
    {
        cout << "market1 is closed!" << endl;
        flag = 0;
    }
    catch(float need_flour)
    {
        cout << "Flour in market1 is not enough. You still need " << need_flour << " grams more." << endl;
        flag = 0;
    }
    catch( int need_egg )
    {
        cout << "Eggs in market1 are not enough. You still need " << need_egg << " more." << endl;
        flag = 0;
    }
